pro ABOVE_tundra_fire_calculate_NDVI_anomaly_and_year_since_fire_V14
...
for i=0, c_burned_PID-1 do begin
    ...
    for year=1985, 2020 do begin
        ...
        temp=fltarr(11, 1)
        temp[0:6]=content[*, index1]
        temp[7]=NDVI_anomaly_burned_unburned
        temp[8]=NDVI_anomaly_background_unburned
        temp[9]=NDVI_anomaly_burned_background
        temp[10]=year-fireyearlist[index1]
...
outfile='C:\Users\itscd\Dropbox\Tables\ABoVE_Tundra_Fire\NDVImax_anomaly_V14.csv'
