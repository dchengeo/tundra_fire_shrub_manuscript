pro ABOVE_tundra_fire_calculate_NDVI_anomaly_and_year_since_fire_V14d
...
outfile='C:\Users\itscd\Dropbox\Tables\ABoVE_Tundra_Fire\NDVImax_anomaly_V14d.csv'
write_csv, outfile, outdata, header=[header[0:-2], 'NDVI_anomaly_burned_unburned', 'NDVI_anomaly_background_unburned', 'NDVI_anomaly_burned_background', 'Age']
